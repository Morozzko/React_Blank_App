...
function removeImportsFromFile(filePath) {
  ...
  const updatedFileContent = fileContent.replace(importRegexpA, '').replace(importRegexB, '')

  fs.writeFileSync(path.resolve(__dirname, filePath), updatedFileContent, 'utf8')
