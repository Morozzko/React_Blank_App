...
// useActions - это пользовательский хук, который принимает объект actions с типом ActionCreatorsMapObject.
...
// useAppActions - это пользовательский хук, который использует useActions для создания объектов действий для различных сервисов.
