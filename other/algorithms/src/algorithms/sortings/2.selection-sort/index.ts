...
// 2. Найти минимальный элемент в оставшейся части массива (то есть в массиве, исключая первый элемент)
// и поменять его местами с элементом на второй позиции.
// 3. Продолжать этот процесс, перемещаясь по массиву и меняя местами каждый элемент с минимальным элементом
